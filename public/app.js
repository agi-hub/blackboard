...
const FONT_PRESETS = [
  ...
  // 英文手写（CDN webfont，Windows/安卓无本地字体也生效；板书英文内容直接手写体）
  {
    id: "board-caveat",
    label: "Caveat（英文手写板书）",
    labelEn: "Caveat (handwriting)",
    stack: `"Caveat",cursive`,
    names: ["Caveat"],
  },
  {
    id: "board-patrick-hand",
    label: "Patrick Hand（英文手写板书）",
    labelEn: "Patrick Hand (handwriting)",
    stack: `"Patrick Hand",cursive`,
    names: ["Patrick Hand"],
  },
  {
    id: "board-indie-flower",
    label: "Indie Flower（英文手写板书）",
    labelEn: "Indie Flower (handwriting)",
    stack: `"Indie Flower",cursive`,
    names: ["Indie Flower"],
  },
  {
    id: "board-dancing-script",
    label: "Dancing Script（英文花体板书）",
    labelEn: "Dancing Script (cursive)",
    stack: `"Dancing Script",cursive`,
    names: ["Dancing Script"],
  },
  {
    id: "board-permanent-marker",
    label: "Permanent Marker（英文记号笔板书）",
    labelEn: "Permanent Marker (marker)",
    stack: `"Permanent Marker",cursive`,
    names: ["Permanent Marker"],
  },
  {
    id: "board-rock-salt",
    label: "Rock Salt（英文粗犷手写板书）",
    labelEn: "Rock Salt (rugged)",
    stack: `"Rock Salt",cursive`,
    names: ["Rock Salt"],
  },
  {
    id: "board-gloria-hallelujah",
    label: "Gloria Hallelujah（英文圆润手写板书）",
    labelEn: "Gloria Hallelujah (round)",
    stack: `"Gloria Hallelujah",cursive`,
    names: ["Gloria Hallelujah"],
  },
  {
    id: "board-amatic-sc",
    label: "Amatic SC（英文细长手写板书）",
    labelEn: "Amatic SC (thin handwriting)",
    stack: `"Amatic SC",cursive`,
    names: ["Amatic SC"],
  },
  {
    id: "board-sacramento",
    label: "Sacramento（英文连笔花体板书）",
    labelEn: "Sacramento (script)",
  ...
  {
    id: "board-playfair",
    label: "Playfair Display（英文衬线板书）",
    labelEn: "Playfair Display (serif)",
  ...
  },
  {
    id: "board-oswald",
    label: "Oswald（英文窄体板书）",
    labelEn: "Oswald (condensed)",
    stack: `"Oswald",sans-serif`,
    names: ["Oswald"],
  },
  {
    id: "board-bebas-neue",
    label: "Bebas Neue（英文全大写板书）",
    labelEn: "Bebas Neue (all-caps)",
    stack: `"Bebas Neue",sans-serif`,
    names: ["Bebas Neue"],
  },
  {
    id: "board-space-mono",
    label: "Space Mono（英文等宽板书）",
    labelEn: "Space Mono (mono)",
    stack: `"Space Mono",monospace`,
    names: ["Space Mono"],
  },
  {
    id: "board-courier-prime",
    label: "Courier Prime（英文打字机板书）",
    labelEn: "Courier Prime (typewriter)",
